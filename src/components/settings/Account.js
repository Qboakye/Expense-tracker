    ...
    <main>
      ...
      <form className="settings-page" onSubmit={handleSubmit}>
        <section className="section-1">
          <header>
            <h3>Profile</h3>
            <p>This is information about you</p>
          </header>
          ...
          <div className="file">
            <label htmlFor="logo" className="logo">
              <svg className="logo-profile" viewBox="0 0 55 55">
                <path
          ...
          <div>
            ...
            <textarea name="about" cols="25" rows="2"></textarea>
          </div>
        </section>
        <hr />
        <section className="section-2">
          <header>
            ...
            <p>Information will not be displayed</p>
          </header>
          <div>
          ...
          <small>
            ...
            {auth.currentUser.metadata.creationTime || "1 / 2 / 2021"}
          </small>
        </section>
